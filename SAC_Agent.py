...
class Agent():
    ...
    def save_models(self):
        print('.... saving models from "{}" ....'.format(self.folder_dir))
    ...
    def load_models(self):
        print('.... loading models from "{}" ....'.format(self.folder_dir))
    ...
    def learn(self):
        ...
        return value_loss.data.tolist(), critic_loss.data.tolist(), actor_loss.data.tolist()

...
class Traffic_Simulator():
    ...
    def envStep(self):
        ...
        self.value_loss = (self.value_loss * len(self.value_loss_history) + vloss)/(len(self.value_loss_history) + 1)
        self.critic_loss = (self.critic_loss * len(self.critic_loss_history) + closs)/(len(self.critic_loss_history) + 1)
        self.actor_loss = (self.actor_loss * len(self.actor_loss_history) + aloss)/(len(self.actor_loss_history) + 1)
